                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <img src="<?php echo base_url('assets/tempdkantin/data/icon_sale.png'); ?>" alt="Category status">
                                        Fashion</a>
                                        <ul class="dropdown-menu mega_dropdown" role="menu" style="width: 850px;">
                                            <li class="block-container col-sm-3 border">
                                                <div class="img_container banner-hover">
                                                    <a href="#">
                                                        <img class="img-responsive" src="<?php echo base_url('assets/tempdkantin/data/banner/b12.png') ?>" alt="sport">
                                                    </a>
                                                </div>
                                            </li>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block-megamenu-img">
                                                    <li class="img_container banner-hover">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url('assets/tempdkantin/data/banner/b13.png'); ?>" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="img_container banner-hover">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url('assets/tempdkantin/data/banner/b14.png'); ?>" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="img_container banner-hover">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url('assets/tempdkantin/data/banner/b15.png'); ?>" alt="sport">
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <img src="<?php echo base_url('assets/tempdkantin/data/icon_hot.png') ?>" alt="Category status">
                                        Mobile & Tablets
                                        </a>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <img src="<?php echo base_url('assets/tempdkantin/data/icon_new.png'); ?>" alt="Category status">
                                        Foods</a>
                                           <ul class="dropdown-menu mega_dropdown" role="menu" style="width: 900px;">
                                            <li class="block-container col-sm-3">
                                                <div class="img_container banner-hover">
                                                    <a href="#">
                                                        <img class="img-responsive" src="<?php echo base_url('assets/tempdkantin/data/banner/b16.png'); ?>" alt="sport">
                                                    </a>
                                                </div>
                                            </li>
                                             <li class="block-container col-sm-3 border">
                                             ...
                                             <li class="block-container col-sm-3">
                                                <div class="img_container banner-hover">
                                                    <a href="#">
                                                        <img class="img-responsive" src="<?php echo base_url('assets/tempdkantin/data/banner/b17.png'); ?>" alt="sport">
                                                    </a>
                                                </div>
                                            </li>
                                             <li class="block-container col-sm-3">
					...
					<div class="block block-vertical-menu">
						...
						<div class="vertical-menu-content">
	                        <ul class="vertical-menu-list">
	                            <li class="ef4896"><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url('assets/tempdkantin/data/1.png'); ?>">Fashion</a>
                        ...
                        <div class="col-md-2 col-sm-4 block-link-wapper">
                            <div class="block-link">
                                <ul class="list-link flag">
                                    ...
                                    <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/flag1.png'); ?>" alt="flang">Customer Support</a></li>
                                    <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/flag2.png'); ?>" alt="flang">Canada</a></li>
                                    <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/flag3.png'); ?>" alt="flang">Mexico</a></li>
                                    <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/flag4.png'); ?>" alt="flang">United Kingdom</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="block-payment">
                        <ul class="list-logo">
                            <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/payment1.png'); ?>" alt="Payment Logo"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/payment2.png'); ?>" alt="Payment Logo"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/payment3.png'); ?>" alt="Payment Logo"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/tempdkantin/data/payment4.png'); ?>" alt="Payment Logo"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
