                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            ?>
                            <li class="dropdown">
                                    <a href="<?php echo site_url('c/').sanitizeStringForUrl($val['name']).'?category='.$val['id']; ?>" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <ul class="block-megamenu-link">
                                            ...
                                            ?>
                                                <li class="link_container">
                                                    <a href="<?php echo site_url('c/').sanitizeStringForUrl($v['name']).'?category='.$val['id']."&c2=".$v['id']; ?>">
                                                        <?php echo $v['name']; ?>
                                                    </a>
                                                </li>
                                            <?php } ?>
