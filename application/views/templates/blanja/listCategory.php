	...
	<div class="container product-page">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-3">
                  <!-- Side Level 2 -->
                      <?php $this->load->view('templates/blanja/feature/product/sideMenuLevel2', ['sideMenu', $sideMenu ,'sideBaru' ,$sideBaru ]); ?>
                  <!-- ./Side Level 2 -->
                  <!-- Catalog -->
                ...
                <?php $this->load->view('templates/blanja/feature/product/topSeller', ['topSeller',$topSeller]); ?>
                <!-- block  top sellers -->
            ...
            <div class="col-xs-12 col-sm-8 col-md-9">
                ...
                <?php
                    ...
                    <div class="category-products">
                        <!-- product list-->
                    		<?php $this->load->view('templates/blanja/feature/productList/productlist', ['listItems' => $listItemss, 'links_pagination' => $links_pagination]); ?>
                        <!-- product list-->
                    ...
                    <div class="category-products">
                        <!-- product list-->
                            <?php $this->load->view('templates/blanja/feature/productList/productGrid', ['listItems' => $listItemss, 'links_pagination' => $links_pagination]); ?>
                        <!-- product list-->
                    </div>
                    <?php } ?>
                <div class="sortPagiBar">
