            ...
            <div class="inner row">
                <div class="product-left col-xs-12 col-sm-5 col-md-4">
                    <div class="product-thumb">
                        <a class="product-img" href="">
                            <img src="<?php echo base_url('attachments/shop_images/').$v['image_product']; ?>" alt="Product">
                        </a>
                ...
                <div class="product-right col-xs-12 col-sm-7 col-md-8">
                    <div class="product-name">
                        <a href="">
                            <?php echo $v['title_product']; ?>
                        </a>
                    </div>
                    <div class="price-box">
                        <span class="product-price"><?php echo numberToRp($v['price_product']); ?></span>
                        <span class="product-price-old"><?php echo numberToRp($v['old_price_product']); ?></span>
                    </div>
                    <div class="desc">
                        <?php
                            echo $v['basic_produc'];
