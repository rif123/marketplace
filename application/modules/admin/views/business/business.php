...
<div id="users">
    <h1><img src="<?= base_url('assets/imgs/admin-user.png') ?>" class="header-img" style="margin-top:-3px;">Type Business</h1>
    <hr>
    ...
    if ($business->result()) {
        ...
        <table class="table table-striped custab">
            <thead>
                <tr>
                    <th>#ID</th>
                    <th>Name Type Business</th>
                    <th>creator</th>
                    <th>Created</th>
                    <th class="text-center">Action</th>
                </tr>
            </thead>
            <?php $i=1; foreach ($business->result() as $key=> $user) { ?>
                <tr>
                    <td><?= $i ?></td>
                    ...
                    <td class="text-center">
                        <div>
                            <a href="?delete=<?= $user->id_type_business ?>" class="confirm-delete">Delete</a>
                            <a href="?edit=<?= $user->id_type_business ?>">Edit</a>
                        </div>
                    </td>
                </tr>
            <?php $i++; } ?>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="username">Name Type Business</label>

                            <input type="text" name="name_type_business" value="<?= isset($edit['name_type_business']) ? $edit['name_type_business'] : '' ?>" class="form-control" id="username">
                        </div>
                    <div class="modal-footer">
                    <?php
                    if (isset($edit['id_type_business'])) {
                      ?>
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>

                      <input type="hidden" name="update" value="<?= isset($data['id_type_business']) ? $data['id_type_business'] : '0' ?>">
