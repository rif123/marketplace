                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('admin/prod-merchant/' .$row['idProd']) ?>" class="btn btn-info">Edit</a>
                                            <a href="<?= base_url('admin/prod-merchant?delete=' . $row['idProd']) ?>"  class="btn btn-danger confirm-delete">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
